...
public class AppPayCore {
    ...
    public static boolean verify(Map<String, String> params, String sign) {
        ...
        return verify(text, sign, AppPayConfig.WECHAT_KEY, AppPayConfig.WECHAT_INPUT_CHARSET);
    }
    ...
    public static String getSignFromParams(Map<String, String> param) {
        ...
        String mysign = sign(prestr, AppPayConfig.WECHAT_KEY, AppPayConfig.WECHAT_INPUT_CHARSET);
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        String stringA = AppPayCore.getSignFromParams(map);
        String sign = AppPayCore.sign(stringA,key,"utf-8").toUpperCase();
