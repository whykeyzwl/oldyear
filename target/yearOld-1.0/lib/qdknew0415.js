        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.body.userHavebuy == 1){
                    $(".fixedMoney").html("￥0"+data.body.price3);
                    $(".unitNum").html("￥0"+data.body.price3.split(".")[0]+".");
                    $(".smallNum").html(data.body.price3.split(".")[1]);
                }else if(data.body.userHavebuy == 0){
                    $(".fixedMoney").html("￥01.0");
                    $(".unitNum").html("￥01.");
                    $(".smallNum").html("0");
                }
            }
